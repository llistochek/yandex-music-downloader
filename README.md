...
Указание пути:
  ...
  --path-pattern <Паттерн>
                        Поддерживает следующие заполнители: #number, #track-artist, #album-artist, #title, #album, #year, #artist-id, #album-id, #track-id, #number-padded, #disc-number, #disc-number-padded (по умолчанию: #album-artist/#album/#number - #title)
